...
export function Video(props: VideoProps) {
    ...
    const { data } = useQuery<GetLessonsBySlugResponse>(GET_LESSON_BY_SLUG, {
        variables: {
            ...
            <div className="p-8 max-w-[1100px] mx-auto">
                ...
                <div className="flex items-start gap-16">
                    ...
                    <div className="flex-1">
                        ...
                        <div className="flex items-center gap-3 mt-6">
                            <img
                                ...
                                alt="Wellington Junio da Silva Albuquerque"
                            />
                    ...
                    <div className="flex flex-col gap-4">
                        <Button to="#" variant="discord" text="Comunidad do Discord" />
                        <Button to="#" variant="challenge" text="Acesse o desafio" />
                    </div>
